...
int adventurerCard(int drawntreasure, struct gameState *state,int currentPlayer,int cardDrawn, int z,int temphand[MAX_HAND])
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		adventurerCard(drawntreasure,state,currentPlayer,cardDrawn, z,temphand);
      	return 0;
    ...
    case remodel:
     	remodelCard(currentPlayer,state,choice1,choice2,handPos); 
		return 0;
