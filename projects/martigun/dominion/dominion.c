...
int useVillage(struct gameState *state, int handPos, int currentPlayer){
...
int useMine(struct gameState *state, int handPos, int currentPlayer, int choice1, int choice2){
...
int useMinion(struct gameState *state, int handPos, int currentPlayer, int choice1, int choice2){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
	  ...
	  useAdventurer(state, handPos, currentPlayer);
	...
	useMine(state, handPos, currentPlayer, choice1, choice2);
    ...
    case smithy:
		...
		useSmithy(state, handPos, currentPlayer);
		return 0;
		
    case village:

	  
	  useVillage(state, handPos, currentPlayer);
    ...
    case minion:
		...
		useMinion(state,handPos, currentPlayer, choice1, choice2);
      return 0;
