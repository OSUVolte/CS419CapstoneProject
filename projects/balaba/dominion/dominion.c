...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	{
	case adventurer:
		return ref_Adventurer(currentPlayer, state);

	case council_room:
		return ref_CounsilRoom(currentPlayer, state, handPos);
	...
	case remodel:
		return ref_Remodel(currentPlayer, state, choice1, choice2, handPos);

	case smithy:
		return ref_Smithy(currentPlayer, state, handPos);
	...
	case baron:
		return ref_Baron(currentPlayer, state, choice1);
...
//##########################################################################
//refactored functions : Adventurer, Smithy, Remodel, Baron and CouncilRoom
//##########################################################################

int ref_Adventurer(int currentPlayer, struct gameState *state){
...
int ref_Remodel(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos){
	int j;
	int i;
...
int ref_Baron(int currentPlayer, struct gameState *state, int choice1){
...
int ref_CounsilRoom(int currentPlayer, struct gameState *state, int handPos){
	int i;
	//+4 Cards
	for (i = 0; i <= 4; i++)
	{
