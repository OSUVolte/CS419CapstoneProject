...
void runAdventurer(struct gameState *state){
...
void runCouncil_room(int handPos, struct gameState *state){
    int i;
    int currentPlayer = whoseTurn(state);
    //+4 Cards
    for (i = 0; i < 4; i++)
...
int runMine(int handPos, struct gameState *state, int choice1, int choice2, int choice3){
    int i, j;
    int currentPlayer = whoseTurn(state);
...
//	}
      ...
      returnVal = runMine(handPos, state, choice1, choice2, choice3);
