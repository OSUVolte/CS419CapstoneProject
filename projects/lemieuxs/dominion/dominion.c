...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case minion:
		return play_minion(currentPlayer, state, handPos, choice1, choice2);
    ...
    case embargo: 
		return play_embargo(currentPlayer, state, handPos, choice1);
		
    case outpost:
		return play_outpost(currentPlayer, state, handPos);
