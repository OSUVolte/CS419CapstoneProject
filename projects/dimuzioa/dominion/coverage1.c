/*********
My test suite would be most improved focusing on different card types, as I've mostly focused on the ones that I touched on in Assignment 2. 

Still, though, I average pretty good code coverage for the functions that I do touch. 
