...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
	...
	/*********************************************************************************************************************	
	**MY_ADVENTURER FUNCTION	
	**********************************************************************************************************************/	
    case adventurer:
      return myAdventurer(state, currentPlayer );
	...
	**********************************************************************************************************************/			
    case feast:
      return myFeast(state, currentPlayer, choice1);
	...
	**********************************************************************************************************************/		
    case remodel:
      return myRemodel(state, currentPlayer, choice1, choice2, handPos);
	
	/*********************************************************************************************************************	
	**MY_SMITHY FUNCTION	
	**********************************************************************************************************************/		
    case smithy:
      return mySmithy(state, currentPlayer, handPos);
	...
	**********************************************************************************************************************/	  
    case tribute:
		return myTribute(state, currentPlayer);
...
int myFeast(struct gameState *state, int currentPlayer, int choice1){
...
int myRemodel(struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos){
...
int myTribute(struct gameState *state, int currentPlayer ){
