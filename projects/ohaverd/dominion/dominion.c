...
// replacement for gardens switch
int drawGardens() {
    return 1;
}

// replacement for smithy switch
...
// replacement for council_room switch
...
// replacement for adventurer switch
int drawAdventurer(struct gameState *state, int handPos, int drawntreasure, int currentPlayer, int temphand[MAX_HAND], int z) {
    int cardDrawn;
...
// replacement for great_hall switch
int drawGreatHall (struct gameState *state, int handPos, int currentPlayer) {
      //+1 Card
      drawCard(currentPlayer, state);
      drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  // update function to call separate functions for the following cards:
