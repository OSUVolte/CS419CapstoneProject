...
int* kingdomCards(int k1, int k2, int k3, int k4, int k5, int k6, int k7,
  ...
  int initializeGame(int numPlayers, int kingdomCards[10], int randomSeed,
    ...
    /***************** Implementation of Five Cards as Functions *****************/
    ...
    int playFeastCard(struct gameState *state, int choice1){
      int currentPlayer = whoseTurn(state);
      int i = 0;
      int x;
      int temphand[MAX_HAND];
    ...
    int playMinionCard(struct gameState *state, int choice1, int choice2, int handPos){
      int currentPlayer = whoseTurn(state);
      int i = 0;
      int j = 0;
      //+1 action
    ...
    int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
    {
      ...
      {
        case adventurer:
        return playAdventurerCard(state);
        ...
        case feast:
        return playFeastCard(state, choice1);
        ...
        case smithy:
        return playSmithyCard(state, handPos);

        case village:
        return playVillageCard(state, handPos);
        ...
        case minion:
        return playMinionCard(state, choice1, choice2, handPos);
