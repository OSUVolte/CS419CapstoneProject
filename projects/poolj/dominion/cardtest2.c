...
** Description: This is the source file for card test 2 which covers
...
int main() {
	...
	int nCards = 2;  /* Number of additional cards */
	...
	testGame.hand[testPlayer][handPos] = adventurer;  /* Add adventurer to test player's hand*/
	...
	if (cardEffect(adventurer, choice1, choice2, choice3, &testGame, handPos, &bonus) == 0) { /* Play smithy card */
