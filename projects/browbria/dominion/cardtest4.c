...
int main() {
	...
	origGS.hand[0][0] = great_hall;
	//put village into player 1's hand, could use TESTCARD, but want obvious declaration
	//village should add a card, increase players actions by 1, and then discard itself
	...
	if (testGS.numActions[player1]-origGS.numActions[player1] == increase)
		{
			printf("PASS -- Actions of player1 increased by 1.");
