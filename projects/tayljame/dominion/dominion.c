...
int smithy_ref(struct gameState* state, int currentPlayer, int handPos)
{
      int i=0;
...
//  int drawntreasure=0;//adventure card
//  int cardDrawn;//adventure card
//  int z = 0;// this is the counter for the temp hand
  ...
  switch( card )
    ...
    case smithy:
        return smithy_ref(state, currentPlayer, handPos);
    case village:
      //+1 Card
      drawCard(currentPlayer, state);
    ...
    case great_hall:
      return great_hall_ref(state,currentPlayer, handPos );
