...
void playSmithyCard(int handPos, struct gameState *state){
    //find current player
...
void playAdventurerCard(struct gameState *state){
     //find current player
    int currentPlayer = whoseTurn(state);
    //set the amount of treasure to 0
    int drawntreasure = 0;
    //set z to 0
    int z = 0;
    int cardDrawn;
...
void playVillageCard(int handPos, struct gameState *state){
       //find current player
    int currentPlayer = whoseTurn(state); 
...
void playGreat_HallCard(int handPos, struct gameState *state){
    //find current player
    int currentPlayer = whoseTurn(state);
...
void playMinionCard(int handPos, int choice1, int choice2, struct gameState *state){
    int i;
    int j;
    //find current player
    int currentPlayer = whoseTurn(state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case smithy:
      playSmithyCard(handPos, state);
          
    case village:
      playVillageCard(handPos, state);
    ...
    case great_hall:
      playGreat_HallCard(handPos, state);
		
    case minion:
      playMinionCard(handPos, choice1, choice2, state);
