...
int salvagerEffect(int choice1, struct gameState *state, int currentPlayer, int handPos){
	//+1 buy
	state->numBuys++;
...
int stewardEffect(int choice1, int choice2, int choice3, struct gameState *state, int currentPlayer, int handPos){
	if (choice1 == 1)
	{
		//+2 cards
  ...
  switch( card ) 
      ...
      else if (choice2)		//discard hand, redraw 4, other players with 5+ cards discard hand and draw 4
	{
      ...
      return 0;
		...
		//*******************************************************************************
    case steward:
			return stewardEffect(choice1, choice2, choice3, state, currentPlayer, handPos);
    ...
    case embargo:
			...
			return embargoEffect(choice1, state, currentPlayer, handPos);
    ...
    case outpost:
      ...
      return 0;
		...
		//***********************************************************************
    case salvager:
			return salvagerEffect(choice1, state, currentPlayer, handPos);
