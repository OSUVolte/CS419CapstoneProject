...
int adventurerCard(int drawntreasure, struct gameState *state, int currentPlayer, int z, int temphand[MAX_HAND])
{
	int cardDrawn;
...
int great_hallCard(int handPos, struct gameState *state, int currentPlayer)
{
      //+1 Card
      drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case remodel:
      remodelCard(state, currentPlayer, choice1, choice2, handPos);
      return 0;
		
    case smithy:
      if (smithyCard(currentPlayer, state, handPos))
		  return 0;
	  return 0;
		
    case village:
	  villageCard(handPos, state, currentPlayer);
      return 0;
    ...
    case great_hall:
      great_hallCard(handPos, state, currentPlayer);
      return 0;
