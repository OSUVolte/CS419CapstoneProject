...
int playCouncil_Room(struct gameState *state, int handPos, int i, int currentPlayer)
{
	for (i = 0; i < 4; i++)
	{
...
int playFeast(struct gameState *state, int choice1, int currentPlayer, int i,int *temphand, int x)
{
