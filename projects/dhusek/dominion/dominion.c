...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return playAdventurer(state, currentPlayer, handPos, temphand);
			
    case council_room:
      return playCouncil_Room(state, handPos, currentPlayer);
			
    case feast:
      return playFeast(state, choice1, currentPlayer, handPos, temphand);
...
int playAdventurer(struct gameState *state, int currentPlayer, int handPos, int *temphand) {
    int drawntreasure=0;
    int cardDrawn;
...
int playFeast(struct gameState *state, int choice1, int currentPlayer, int handPos, int *temphand) {
    int i;
    int x;
