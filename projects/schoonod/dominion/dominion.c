...
//        printf("loop1 iter%i, score is %i\n", i, score);
...
//        printf("loop2 iter%i, score is %i\n", i, score);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus){
  ...
  switch( card ) 
    ...
    case council_room:
            councilRoomCard(i, currentPlayer, state, handPos);
            return 0;
			
    case feast:
            feastCard(i, currentPlayer, state, temphand, x, choice1);
            return 0;
    ...
    case mine:
            mineCard(i, j, state, choice1, currentPlayer, choice2, handPos);
            return 0;
