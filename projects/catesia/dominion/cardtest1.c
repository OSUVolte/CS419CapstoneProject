...
int main () {
    ...
    cardEffect(smithy, 0, 0, 0, &testStatePost, 0, &bonus);
    
    //Tests
    if (testState.deckCount[currentPlayer] != testStatePost.deckCount[currentPlayer]+3) {
    ...
    if (testState.handCount[currentPlayer] != testStatePost.handCount[currentPlayer]-2) {
