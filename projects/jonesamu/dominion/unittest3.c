...
Sam Jones
Date: 04/25/16
Description: updateCoins() Unit test   
- Test all coin cards, hands containing only coins, 
	hands without coins, and hands with coins and cards
- Test positive and negative values for bonus
*/
#include<stdio.h>
#include "dominion.h"
