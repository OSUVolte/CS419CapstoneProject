...
void playCouncil_Room(int currentPlayer, struct gameState *state, int handPos)
{
	int i;
	for (i = 0; i < 4; i++)
	{
...
void playGardens(int currentPlayer, struct gameState *state, int handPos)
{
	int i;
...
playMine(int choice1, int choice2, int currentPlayer, struct gameState *state, int handPos)
{
	int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case gardens:
	  playGardens(currentPlayer, state, handPos);
      return -1;
			
    case mine:
	  playMine(choice1, choice2, currentPlayer, state, handPos);
      return 0;
