...
int playAdventurer(struct gameState *state){
    ...
    //The lines below were moved from cardEffect() but outside the switch statement
    ...
    //Except where noted, the lines below were moved from cardEffect()'s switch statement's adventurer branch
...
//Modified to switch to functions in the case of 5 cards:
//smithy, adventurer, village, feast, council_room
